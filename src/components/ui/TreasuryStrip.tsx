  ...
  return (
    <div className="treasury-strip">
      <div className="treasury-inner">
        ...
        <div>
          <div className="t-label">Sonraki dağıtım</div>
          <div className="t-value">{countdownStr}</div>
        </div>
        <div className="t-divider" />
        <div>
          <div className="t-label">Dağıtım oranı</div>
          ...
          <div className="t-dist-label">
            Platform %26 · Yazarlar %56 · Okuyucular %18
          </div>
        </div>
        <a className="t-cta" href="/treasury">Kasayı incele</a>
      </div>
    </div>
  );
}
